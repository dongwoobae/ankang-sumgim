        ...
        <div className="space-y-2">
          {faqs.map((faq, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-[#FFFFFF] border rounded-xl overflow-hidden"
                style={{
              ...
              >
                ...
                >
                  <div className="flex items-start gap-3">
                    <span
                      className="flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold mt-0.5 transition-colors"
                      style={{
                  ...
                  <ChevronDown
                    ...
                    style={{
                      color: isOpen ? "#1A56A0" : "#5A7A99",
                      transform: isOpen ? "rotate(180deg)" : "rotate(0deg)",
                    }}
                  />
                </button>

                {/* 답변 — grid 트릭으로 slide 애니메이션 */}
                <div
                  style={{
                    display: "grid",
