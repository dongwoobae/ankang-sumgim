...
const steps = [
  ...
  { n: "03", title: "의사소견서", desc: "의사에게 소견서를 발급받아 제출합니다. (65세 미만은 필수)" },
  { n: "04", title: "등급판정", desc: "등급판정위원회에서 1~5등급 또는 인지지원등급을 결정합니다." },
  { n: "05", title: "서비스 이용", desc: "장기요양인정서를 받고 기관과 계약 후 서비스를 시작합니다." },
];
    ...
    <>
        ...
        <div className="px-6">
          <div className="mx-auto max-w-[860px] space-y-20">
              ...
              <div id="ins-process">
                ...
                <h2
                  className="mb-2 text-[26px] font-extrabold"
                  style={{ color: "var(--ink-2)" }}
                >
                  신청 절차
                </h2>
      ...
      <section className="px-6 py-14">
        <div className="mx-auto max-w-[860px]">
          <SiblingNav
            next={{ label: "방문요양", desc: "재가 방문요양 서비스 안내", href: "/services/visit-care" }}
          />
        </div>
      </section>
