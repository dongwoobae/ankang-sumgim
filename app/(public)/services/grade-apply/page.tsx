  ...
  return (
    <>
      <PageHero
        ...
        crumbs={[{ label: "홈", href: "/" }, { label: "서비스 안내" }, { label: "등급신청 안내" }]}
      />
        ...
        <div className="px-6">
          <div className="mx-auto max-w-[860px] space-y-20">
            ...
            <div id="apply-what">
              ...
              >
                <p>
                  노인장기요양보험 등급신청은 거동이 불편하거나 치매 등 노인성 질환으로 일상생활에
                  도움이 필요한 어르신이 국민건강보험공단에 요양 등급을 신청하는 절차입니다.
                </p>
                <p>
                  등급을 받으시면 방문요양·가족요양·인지활동서비스 등 다양한 장기요양급여를 본인
                  부담금(15% 내외)만으로 이용하실 수 있습니다. 저희 센터에서 신청 대행부터 서비스
                  연결까지 함께 도와드립니다.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="grid grid-cols-2 gap-3 self-start">
                  <div className="rounded-2xl p-5 text-center" style={{ background: "var(--pop)" }}>
