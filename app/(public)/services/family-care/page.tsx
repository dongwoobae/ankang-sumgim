    ...
    <div>
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-[#8C8070] mt-3">가족이 직접 돌보며 급여를 받을 수 있습니다</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-start">
            <div>
              ...
              <div className="mt-8 p-5 bg-[#FAF3D6] border border-[#D9C97A]/50 rounded-xl">
                <p className="text-[#5C4A1E] font-bold text-sm mb-3">대상 가족 범위</p>
            ...
            <div className="space-y-5">
              {/* 이용 조건 */}
              <div className="bg-[#FAF3D6] border border-[#D9C97A]/50 rounded-xl p-6">
                <h3
                  className="text-[#5C4A1E] font-bold mb-4"
                  style={{ fontFamily: "'Noto Serif KR', serif" }}
                >
                  이용 조건
                </h3>
                <ul className="space-y-2.5">
                  {conditions.map((c, i) => (
                    <li key={i} className="flex items-start gap-2 text-[#5C4A1E] text-sm leading-relaxed">
                      <CheckCircle size={13} className="text-[#C4A84F] flex-shrink-0 mt-1" />
                      {c}
                    </li>
                  ))}
                </ul>
              ...
              {/* 주의사항 */}
              <div className="flex items-start gap-3 p-5 bg-[#E8D48B]/20 border border-[#D9C97A]/60 rounded-xl">
                <AlertCircle size={18} className="text-[#C4A84F] flex-shrink-0 mt-0.5" />
                <p className="text-[#5C4A1E] text-sm leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5 mb-12">
            {steps.map((s, i) => (
              <div
                key={i}
                className="bg-[#FFFDF0] border border-[#D9C97A]/50 rounded-xl p-6"
              >
                <div className="w-10 h-10 rounded-full bg-[#C4A84F] text-[#FFFDF0] font-bold flex items-center justify-center mb-4 text-sm">
                  {i + 1}
                </div>
                <p
          ...
          <div className="text-center">
            <p className="text-[#8C8070] text-sm mb-5">
              가족요양 신청에 대한 자세한 상담은 저희 센터에 문의해 주세요.
            </p>
            <div className="flex flex-wrap gap-3 justify-center">
              <Link
                href="/inquiry"
                className="flex items-center gap-2 bg-[#C4A84F] text-[#FFFDF0] px-7 py-4 rounded-xl font-bold text-sm hover:bg-[#5C4A1E] transition-colors duration-300"
              >
                온라인 상담 신청 <ArrowRight size={16} />
              </Link>
              <a
                href="tel:054-763-5988"
                className="flex items-center gap-2 border-2 border-[#C4A84F] text-[#C4A84F] px-7 py-4 rounded-xl font-bold text-sm hover:bg-[#C4A84F] hover:text-[#FFFDF0] transition-colors duration-300"
              >
                <Phone size={16} />
                054-763-5988
              </a>
