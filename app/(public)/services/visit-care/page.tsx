    ...
    <div>
      ...
      >
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-[#8C8070] mt-3">가정을 직접 방문하여 정성껏 돌봄을 제공합니다</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {highlights.map((h, i) => (
              <div key={i} className="text-center">
                <p className="text-[#8C8070] text-xs tracking-widest mb-1">{h.title}</p>
                <p
                ...
                <p className="text-[#8C8070] text-xs">{h.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#FFFDF0] py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-start">
            <div>
              <p className="text-[#C4A84F] text-sm font-semibold tracking-widest mb-2">WHAT WE DO</p>
              <h2
            ...
            <div className="space-y-5">
              {serviceItems.map((si, i) => (
                ...
                >
                  <h3
                    className="text-[#5C4A1E] font-bold mb-3"
                    style={{ fontFamily: "'Noto Serif KR', serif" }}
                  >
                    {si.category}
                  </h3>
                  <div className="flex flex-wrap gap-2">
                    {si.items.map((item, j) => (
                      <span
                        key={j}
                        className="text-xs bg-[#FFFDF0] text-[#5C4A1E] px-3 py-1 rounded-full border border-[#D9C97A]/60"
                      >
                        {item}
                      </span>
                    ))}
      ...
      <section className="bg-[#FAF3D6] py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-10">
            <p className="text-[#C4A84F] text-sm font-semibold tracking-widest mb-2">HOW TO USE</p>
            <h2
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
            {[
              ...
              <div
                key={i}
                className="bg-[#FFFDF0] border border-[#D9C97A]/50 rounded-xl p-5 text-center"
              >
                <div className="w-10 h-10 rounded-full bg-[#C4A84F] text-[#FFFDF0] font-bold flex items-center justify-center mx-auto mb-4">
                  {s.step}
                </div>
                <p
