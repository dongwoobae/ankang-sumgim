    ...
    <form action={action} className="space-y-6">
      ...
      <div>
        <label className="block text-[#5C4A1E] text-sm font-medium mb-1.5">
          제목 <span className="text-[#C4A84F]">*</span>
        </label>
        <input
          name="title"
          type="text"
      ...
      <div>
        <label className="block text-[#5C4A1E] text-sm font-medium mb-1.5">
          내용 <span className="text-[#C4A84F]">*</span>
        </label>
        <textarea
          name="content"
          required
      ...
      {/* 상단 고정 */}
      <div className="flex items-center gap-3 p-4 bg-[#FAF3D6] border border-[#D9C97A]/50 rounded-xl">
        <input
          id="is_pinned"
          name="is_pinned"
          type="checkbox"
          defaultChecked={defaultValues?.is_pinned}
          className="w-4 h-4 accent-[#C4A84F]"
        />
        <label htmlFor="is_pinned" className="text-[#5C4A1E] text-sm font-medium cursor-pointer">
          공지 목록 상단에 고정
        </label>
      </div>
